...
*/
-- Insertion 1
INSERT INTO t_books (title_book, pages_book, extract_book, summary_book, cover, year_book, average_book, upload_book, fk_publishers, fk_author, fk_category, fk_user, created, updatedAt)
VALUES 
